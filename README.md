...
- [DEMO LINK](https://yuriathila.github.io/layout_calendar/)
- [TEST REPORT LINK](https://yuriathila.github.io/layout_calendar/report/html_report/)

- [x] Changing 'month-length' and 'start-day' modifier in the code element reflects in changing calendar layout
